...
export default function ArticleCard({ article }: Props) {
    return (
        <div className="bg-indigo-50 leading-normal rounded-md p-4 shadow-md hover:scale-105 transition-transform">
            
            <h2 className="p-1.5 text-xl font-semibold text-zinc-900 line-clamp-1">{article.title}</h2>
            <p className="p-2 text-zinc-700 line-clamp-2">{article.body}</p>
